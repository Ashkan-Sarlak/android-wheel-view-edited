...
public class WheelView extends View {
	...
	private static final int DEF_VISIBLE_ITEMS = 3; // TODO my change 5 -> 3
	...
	private void initResourcesIfNecessary() {
		if (centerDrawable == null) {
			centerDrawable = getContext().getResources().getDrawable(
					R.drawable.wheel_val_edited_ashkan); // TODO my change R.drawable.wheel_val -> R.drawable.wheel_val_edited_ashkan
		}
		...
		// setBackgroundResource(R.drawable.wheel_bg); TODO my change
	}
	...
	protected void onDraw(Canvas canvas) {
		...
		// drawShadows(canvas); TODO my change
	}
